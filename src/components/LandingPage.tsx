...
const SAFETY: { Icon: LucideIcon; head: string; body: string }[] = [
  ...
  // 2026-08-18: 実物は引き止め1枚＋理由選択1枚が出るので、言葉を実物に合わせた（Iris 側と同文）
  { Icon: Check, head: '解約は画面の中で完結。電話も面談もありません', body: '理由の入力は任意で、選ばなくてもそのまま解約できます。引き止めの画面は1枚だけ出ますが、押せば先へ進めます。期間末まではお使いいただけます。' },
