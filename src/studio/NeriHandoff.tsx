...
export default function NeriHandoff({ where }: { where: 'home' | 'care' }) {
  return (
    <Band dark wide pad="clamp(52px, 6vw, 84px) 0">
      ...
      <p style={{ color: D.body, lineHeight: 1.9, marginBottom: 24 }}>制作を入口に、SNS・集客の改善、営業の仕組み、会社の記憶へ。必要な業務からつなぎ、御社専用のAI Company OSへ育てます。<br /><a href="https://www.core-ai.jp/corp#company-os-definition" style={{ color: D.gold }}>Company OSの進め方・納品範囲を見る →</a></p>
