...
export const FILM = {
  ...
  hero: '撮影をせずに、\n広告に出せる映像を。',
  // 375px で3行に収める長さに抑える。ここが4行を超えると、その分だけCTAが1画面目から落ちる
  // (実測: 7行の版で主CTAが折り目の99px下にあった)。撮影が不要である利点は「費用の構造」の章で詳述する。
  heroSub: '生成AIを制作技術として使う映像制作スタジオです。企画・脚本・ディレクション・仕上げまで、当社が一貫して担当します。',
  heroCta: '制作の相談・お見積りを依頼する',
  heroCtaSub: '料金と条件を見る',
  /** 実績への導線。情緒より先に証拠を見せる */
  heroCtaWorks: '制作実績を見る',
  /** ヒーロー直下の数字。すべて当ページ内で検証できる事実のみを置く (推定値・水増し禁止) */
  proof: [
    { value: '¥49,800〜', label: '単発1本の制作費' },
...
export const PRICE_WHY = '映像の尺・本数・制作内容によって料金が変わります。まずは用途を伺い、最適な構成をお見積りとしてご提示します。';
...
export const VALUE = {
  ...
  table: [
    { item: 'SNS短尺 (15〜30秒) 1本', market: '¥50,000 〜 250,000', core: '¥49,800 〜 128,000' },
...
export const FILM_FAQ: FilmFaq[] = [
  ...
  { q: '1本だけでも依頼できますか', a: 'できます。TRIALは初めてのお取引にかぎった1本の価格で、完成品をご覧いただいたうえで継続をご判断いただけます。' },
  ...
  { q: '料金はいくらからですか', a: '単発は¥49,800（TRIAL・初めてのお取引にかぎった1本）から、継続制作は月4本¥228,000からです。同じ本数を単発で制作した場合との差額は、料金セクションに記載しています。' },
