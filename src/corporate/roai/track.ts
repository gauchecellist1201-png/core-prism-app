...
export const ROAI_EVENTS = new Set<string>([
  ...
  'corp_interest',         // ホームの章が画面に入った（label = transformation / studio / neri / ashitaka / energy / vision）
  'corp_intent',           // 招待で選んだ意図（label = transform / region / venture / ashitaka / energy / partner）
