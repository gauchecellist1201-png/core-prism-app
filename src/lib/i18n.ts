...
const TRANSLATIONS: Translations = {
  ...
  'lp.hero.sub2': {
    ja: 'CORE Prism は、ひとつの白い光を 7つの人格に分散させる、エージェント AI の OS。',
    en: 'CORE Prism is an agent AI OS that splits one white light into 7 distinct personas.',
    zh: 'CORE Prism 是一个智能体AI操作系统，将一束白光分散为7种人格。',
  },
  ...
  'iris.hero.sub2': {
    ja: 'あなたの中にある「影響力」という光を、\nAI エージェントが見つけ、磨き、世界に放つ。',
    en: 'The AI agents find the light of influence within you,\npolish it, and release it into the world.',
    zh: '你内心的"影响力之光"，\nAI智能体帮你发现、打磨、释放到世界。',
  },
