...
export default function App() {
  ...
  if (window.location.pathname === '/continuum' || window.location.pathname.startsWith('/continuum/')) {
    return <Suspense fallback={<RouteFallback />}><ContinuumLanding /><LpStickyCta title="あなたが働かなくても、事業が回り続ける。" sub="CORE Continuum ── 6つのAIをひとつに" cta="プランを見る" href="#plans" accent1="#e9cd8a" accent2="#c9a24b" /></Suspense>;
  }
