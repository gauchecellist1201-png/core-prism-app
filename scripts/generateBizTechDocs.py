...
'Prism': dict(acc=(0x4B,0x57,0xB0), role='全事業の司令塔・経営AIエージェントOS', url='core-prism-app.vercel.app',
  biz=dict(
   ...
   pricing=[['7日間無料','¥0/7日間','全機能トライアル・クレカ不要'],['Starter','¥4,800/月','個人・基本AI'],
            ['Standard','¥9,800/月','全AI・無制限（人気No.1）'],['Exclusive','¥29,800/月','法人・専任CS・導入伴走'],['（参考）Studio','¥98,000/月','エンタープライズ・要問合せ']],
...
'Iris': dict(acc=(0xA8,0x49,0x7B), role='インフルエンサーのためのInstagram運用AI', url='core-prism-app.vercel.app/iris',
  biz=dict(
   ...
   pricing=[['7日間無料','¥0/7日間','全機能トライアル・クレカ不要'],['Lite','¥2,800/月','入門・副業'],['Standard','¥6,800/月','本気のクリエイター（人気No.1）'],
            ['Pro','¥9,800/月','チーム/マネージャー'],['Studio','¥29,800/月','事務所/代理店・ホワイトラベル']],
...
'Resonance': dict(acc=(0x2E,0x8B,0x6F), role='店舗・サロン・教室のためのLINE個別配信SaaS', url='resonancebot-ivory.vercel.app',
  biz=dict(
   ...
   pricing=[['7日間無料','¥0/7日間','全機能トライアル・クレカ不要'],['Pro','¥980/月','1アカウント・月3,000通（人気）'],
            ['Business','¥2,980/月','3アカウント・月15,000通'],['Premium','¥4,980/月','10アカウント・月50,000通']],
...
'Lume': dict(acc=(0x6A,0x57,0xC8), role='クリエイターのためのリンクハブ＋クリック解析', url='lume-deploy-five.vercel.app',
  biz=dict(
   ...
   pricing=[['7日間無料','¥0/7日間','全機能トライアル・クレカ不要'],['Pro','¥980/月','解析フル機能（人気）'],['Business','¥2,980/月','複数プロフィール管理']],
  ...
  tech=dict(
   ...
   billing='Stripe（CORE Incアカウント, Lume Pro ¥980 / Business ¥2,980）。7日間トライアル（trial_period_days=7、8日目課金）に統一。',
