...
'iris': dict(en='CORE IRIS', file='Iris', slides=[
    ...
    ('price', ('料金 — プランごとの「できること」。', [
        ('Free', '¥0', '7日間 全機能おためし', False),
        ('Lite', '¥2,980', 'AI相談50回・案件管理無制限', False),
        ('Standard', '¥6,980', 'リール自動生成・解析ほぼ無制限', True),
        ('Pro', '¥12,800', 'チーム5名・運用代行', False),
...
'resonance': dict(en='CORE RESONANCE', file='Resonance', slides=[
    ...
    ('price', ('料金 — プランごとの「できること」。', [
        ...
        ('Solo', '¥1,980', 'AI個別配信・1アカ・月2,000通', False),
        ('Pro', '¥4,980', 'AIレター・1アカ・月8,000通', True),
        ('Business', '¥9,800', '3アカ・月30,000通・設定代行', False),
...
'lume': dict(en='CORE LUME', file='Lume', slides=[
    ...
    ('price', ('料金 — プランごとの「できること」。', [
        ('7日間無料', '¥0', '全機能を7日間おためし', False),
        ('Pro', '¥1,480', 'ヒートマップ・流入元・時間帯解析', True),
        ('Business', '¥3,480', '複数プロフィール管理', False),
    ], '全プラン 7日間無料・クレジットカード登録不要')),
...
def build_combined():
    ...
    s_product_intro('iris', 'Iris — Instagram',
                    '投稿・分析・案件・DM返信・交渉。Instagram運用の六つの仕事を、ひとつのアプリに。', '月 ¥2,980〜 ・ 7日間無料')
    s_product_intro('resonance', 'Resonance — LINE',
                    '名簿の一人ひとりにAIが文面を書き分け、LINEで手紙のように届ける個別配信。', '月 ¥1,980〜 ・ 7日間無料')
    s_product_intro('lume', 'Lume — リンク',
                    'すべてのリンクをひとつに束ね、誰がどこを踏んだかを色と熱で可視化するハブ。', '月 ¥1,480〜 ・ 7日間無料')
    ...
    rows = [('Prism', '全事業の司令塔', '月 ¥4,800〜', '#a78bfa'),
            ('Iris', 'Instagram運用', '月 ¥2,980〜', '#E1306C'),
            ('Resonance', 'LINE個別配信', '月 ¥1,980〜', '#06C755'),
            ('Lume', 'リンクハブ＋解析', '月 ¥1,480〜', '#FFA42A')]
    y0 = 2.5
