/* ============================================================
 * CORE Prism Concierge — 設置用ローダー (この1行で設置)
 *
 *   <script src="https://core-prism-app.vercel.app/prism-concierge.js"
...
(function () {
  ...
  if (!script) {
    ...
    for (var i = all.length - 1; i >= 0; i--) {
      if ((all[i].src || '').indexOf('prism-concierge.js') !== -1) { script = all[i]; break; }
    }
  }
  if (!script) return;
  ...
  var url = origin + '/concierge?embed=1' + (cfg ? '&c=' + encodeURIComponent(cfg) : '');
